...
export async function getProviderRequests(): Promise<{
  ...
  if (!callerRole || !["super_admin", "admin", "clinic_admin", "nurse", "doctor", "dentist"].includes(callerRole)) {
...
export async function createProviderRequest(request: {
  ...
  const callerRole = user.user_metadata?.role as string | undefined;
  if (!callerRole || !["super_admin", "admin", "clinic_admin", "nurse", "clinic_staff", "doctor", "dentist"].includes(callerRole)) {
...
export async function updateProviderRequestStatus(
  ...
  const callerRole = user.user_metadata?.role as string | undefined;
  if (!callerRole || !["super_admin", "admin", "clinic_admin", "doctor", "dentist"].includes(callerRole)) {

...
import { Button, Input, FormField, Card, CardContent, Alert, AlertDescription } from "@repo/ui";
      ...
      <div className="w-full max-w-md space-y-6">
        <div className="flex flex-col items-center gap-3">
          ...
          <div className="text-center">
            <h1 className="text-2xl font-bold text-slate-900">Welcome to UCare AI</h1>

  ...
  return (
    <div className="relative">
      <button
        ...
        className="relative flex h-10 w-10 items-center justify-center rounded-lg text-slate-400 transition-colors hover:bg-slate-100 hover:text-slate-600"
      ...
      {isOpen && (
        <>
          ...
          <div className="absolute right-0 top-full z-[60] mt-2 w-[380px] max-h-[500px] overflow-hidden rounded-xl border border-slate-200 bg-white shadow-lg">
            ...
            <div className="overflow-y-auto max-h-[400px]">
              {loading ? (
                ...
                notifications.map((n) => (
                  <div
                    key={n.id}
                    className={`flex gap-3 border-b border-slate-100 px-4 py-3 transition-colors ${
                  ...
                  >
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="mt-1 text-sm font-medium text-slate-900 truncate">{n.title}</p>
